...
export const userLinks = (loggedIn: boolean): NavItemProps[] =>
  loggedIn
    ? [
...
export const recipeLinks = (loggedIn: boolean): NavItemProps[] =>
...
export const resources = (loggedIn: boolean): NavItemProps[] =>
